...
public class Habitacion {
    ...
    public boolean realizarCheckIn(List<Pasajero> ocupantes) {
        if (this.estado == EstadoHabitacion.RESERVADA || this.estado == EstadoHabitacion.DISPONIBLE) {
    ...
    public LocalDateTime getUltimaModificacionEstado() {
        return ultimaModificacionEstado;
    }

    public void setUltimaModificacionEstado(LocalDateTime ultimaModificacionEstado) {
        this.ultimaModificacionEstado = ultimaModificacionEstado;
    }
